...
{
    public partial class frm_Student_App_Login : Form
    {
        public frm_Student_App_Login()
        {
            InitializeComponent();
        }
        ...
        private void btn_Submit_Click(object sender, EventArgs e)
        {
            ...
            Cmd.Connection = Con;
            Cmd.CommandText = "Select Count(*) From Student_List Where Username = @Uname And Password = @Pwd";
