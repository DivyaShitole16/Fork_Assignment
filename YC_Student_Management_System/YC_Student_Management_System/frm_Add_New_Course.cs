...
namespace YC_Student_Management_System
{
    public partial class frm_Add_New_Course : Form
    {
        ...
        int Auto_Incr()
        {
            ...
            Con_Open();
            Cmd.CommandText = "Select Count(Course_ID) From Course_Detail";
            Cmd.Connection = Con;
        ...
        void frm_Add_New_Course_Load(object sender, EventArgs e)
        {
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlDataAdapter sda = new SqlDataAdapter("Insert Into Course_Detail values(" + tb_Course_ID.Text + ",'" + tb_Course_Name.Text + "')", Con);
